...
alias aws_mp-mgmt='export AWS_PROFILE=mp-mgmt && aws sso login --sso-session mantlepulse'
alias aws_mp-workload='export AWS_PROFILE=mp-workload && aws sso login --sso-session mantlepulse'
alias aws_whoami='aws sts get-caller-identity'
alias aws_login='aws sso login'
alias pvmkvenv='python -m venv .venv'
alias obs_studio='flatpak run com.obsproject.Studio > /dev/null 2>&1 &'
